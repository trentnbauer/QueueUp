...
import type { ApplyTagRequest, BadgeDefinition, CreateTagRequest, Game, RenameTagRequest, Tag } from '@queueup/shared';
...
export const tagsApi = {
  ...
  applyToGame: (gameId: string, body: ApplyTagRequest) =>
    apiPost<{ game: Game; unlockedBadges: BadgeDefinition[] }>(`/api/games/${gameId}/tags`, body),
