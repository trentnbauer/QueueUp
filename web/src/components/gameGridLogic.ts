...
/** The platform/genre/status/tag/neglected/stale-wishlist/coop-ready/search predicate GameGrid
 * renders by - pulled out so any other place that needs to know "what's actually visible" (e.g. the Personal
